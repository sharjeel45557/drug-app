...
<style>
  ...
  *{ box-sizing:border-box; -webkit-tap-highlight-color:transparent; }
  ...
  .controls{ padding:12px 0 10px; }
  /* Stories live in their own scroll window so the page itself stays short. */
  #feed{ max-height:68vh; overflow-y:auto; -webkit-overflow-scrolling:touch;
         border:1px solid var(--line); border-radius:16px; padding:12px 12px 4px;
         background:var(--bg); box-shadow:inset 0 -10px 12px -10px rgba(0,0,0,.12); }
...
<script defer src='https://static.cloudflareinsights.com/beacon.min.js' data-cf-beacon='{"token": "651cbd33101545cab5993cc1d8837dd3"}'></script>
